...
const isOwner = [`${setting.ownerNumber}`,"6285788309825@s.whatsapp.net","6285788309825@s.whatsapp.net"].includes(sender) ? true : false
...
*_Seputar DenisBot & transaksi_*

${strip}Telpon/Spam blokir 🚫${strip}

_Admin 1 : 0857-8830-9825_
_Admin 2 : 0857-8830-9825_
...
const gurbot = '6285788309825@s.whatsapp.net'
...
var bg_lexxy = '6285788309825@s.whatsapp.net'
...
var dev = '6285788309825@s.whatsapp.net'
